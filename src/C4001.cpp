...
void C4001::simulate(size_t tick)
{
    ...
    this->getPin(3)->change_state(myNOR(this->getPin(1)->get_state(), this->getPin(2)->get_state()));
    this->getPin(4)->change_state(myNOR(this->getPin(5)->get_state(), this->getPin(6)->get_state()));
    this->getPin(10)->change_state(myNOR(this->getPin(8)->get_state(), this->getPin(9)->get_state()));
    this->getPin(11)->change_state(myNOR(this->getPin(12)->get_state(), this->getPin(13)->get_state()));
...
{
            std::cout << "4001 component" << std::endl;
            std::cout << "14 pins\n" << std::endl;
}